...
dependenciesAll<-c("shiny", "rtools","sf","circular","shinyjs","shinyBS","sp","ggplot2","mapboxer","rgdal","adehabitatHR","RSQLite","move","shinycssloaders","raster","adehabitatLT","BBMM","R.utils",
  "lubridate","stringr","parallel","R.utils","dplyr","ctmm","fields","smoothr","rgeos","suncalc")
...
ui <- fluidPage(
  ...
  column(12,
    HTML("<div style='width:100%; height:3rem; padding:4rem; font-size:3rem; margin-bottom:2rem; padding-bottom:6rem; background-color:black; color:white;'>Welcome to Migration Mapper v3.0!</div>"),
    column(12,
      column(4,
